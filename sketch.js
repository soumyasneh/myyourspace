...
var iknew, iknimg;
var blsound;
var lowsound,lossound,wonsound,wavesound,atmospheresnd;
...
function preload()
{
//welcome = loadSound('welrec.wav');	
blsound = loadSound('blast.wav');
lowsound = loadSound('loosers.wav');
lossound = loadSound('loss.wav');
wonsound = loadSound('awarded.wav');
atmospheresnd = loadSound('atm.wav');
wavesound = loadSound('clck.wav');
